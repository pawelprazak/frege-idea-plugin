package org.fregelang.plugin.idea.actions;
...
public final class NewFregeFileAction extends CreateElementActionBase {
    ...
    private static final String WHAT = "Frege module";

    public NewFregeFileAction() {
        super(WHAT, "Creates new " + WHAT, FregeFileType.INSTANCE.getIcon());
    }
    ...
    protected PsiElement[] create(String newName, PsiDirectory directory) throws Exception {
        FregeFileType type = FregeFileType.INSTANCE;
